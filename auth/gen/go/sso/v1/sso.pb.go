...
func (x *ProfileResponse) GetServices() []string {
	if x != nil {
		return x.Services
	}
	return nil
...
const file_sso_v1_sso_proto_rawDesc = "" +
	...
	"\bservices\x18\t \x03(\tR\bservices\x12+\n" +
	"\bsessions\x18\n" +
	" \x03(\v2\x0f.sso.v1.SessionR\bsessions\"\x84\x01\n" +
	"\aSession\x12\x0e\n" +
...
var file_sso_v1_sso_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_sso_v1_sso_proto_goTypes = []any{
	...
	(*Session)(nil),               // 5: sso.v1.Session
	(*CheckConfirmRequest)(nil),   // 6: sso.v1.CheckConfirmRequest
	(*CheckConfirmResponse)(nil),  // 7: sso.v1.CheckConfirmResponse
	(*CheckForgotRequest)(nil),    // 8: sso.v1.CheckForgotRequest
	(*CheckForgotResponse)(nil),   // 9: sso.v1.CheckForgotResponse
	(*ResetRequest)(nil),          // 10: sso.v1.ResetRequest
	(*ResetResponse)(nil),         // 11: sso.v1.ResetResponse
	(*EmailRequest)(nil),          // 12: sso.v1.EmailRequest
	(*EmailResponse)(nil),         // 13: sso.v1.EmailResponse
	(*ForgotRequest)(nil),         // 14: sso.v1.ForgotRequest
	(*ForgotResponse)(nil),        // 15: sso.v1.ForgotResponse
	(*PasswordRequest)(nil),       // 16: sso.v1.PasswordRequest
	(*PasswordResponse)(nil),      // 17: sso.v1.PasswordResponse
	(*RegisterRequest)(nil),       // 18: sso.v1.RegisterRequest
	(*RegisterResponse)(nil),      // 19: sso.v1.RegisterResponse
	(*LoginRequest)(nil),          // 20: sso.v1.LoginRequest
	(*LoginResponse)(nil),         // 21: sso.v1.LoginResponse
	(*TokenRequest)(nil),          // 22: sso.v1.TokenRequest
	(*TokenResponse)(nil),         // 23: sso.v1.TokenResponse
	(*LogoutRequest)(nil),         // 24: sso.v1.LogoutRequest
	(*LogoutResponse)(nil),        // 25: sso.v1.LogoutResponse
	(*MassLogoutRequest)(nil),     // 26: sso.v1.MassLogoutRequest
	(*MassLogoutResponse)(nil),    // 27: sso.v1.MassLogoutResponse
	(*Empty)(nil),                 // 28: sso.v1.Empty
	(*JWKSResponse)(nil),          // 29: sso.v1.JWKSResponse
	(*JWK)(nil),                   // 30: sso.v1.JWK
	(*ValidateRequest)(nil),       // 31: sso.v1.ValidateRequest
	(*ValidateResponse)(nil),      // 32: sso.v1.ValidateResponse
	(*RefreshRequest)(nil),        // 33: sso.v1.RefreshRequest
	(*RefreshResponse)(nil),       // 34: sso.v1.RefreshResponse
	(*AccessTokenRequest)(nil),    // 35: sso.v1.AccessTokenRequest
	(*AccessTokenResponse)(nil),   // 36: sso.v1.AccessTokenResponse
	(*timestamppb.Timestamp)(nil), // 37: google.protobuf.Timestamp
}
var file_sso_v1_sso_proto_depIdxs = []int32{
	2,  // 0: sso.v1.ServicesResponse.services:type_name -> sso.v1.StructureServices
	37, // 1: sso.v1.StructureServices.created_at:type_name -> google.protobuf.Timestamp
	37, // 2: sso.v1.ProfileResponse.createdAt:type_name -> google.protobuf.Timestamp
	5,  // 3: sso.v1.ProfileResponse.sessions:type_name -> sso.v1.Session
	37, // 4: sso.v1.Session.created:type_name -> google.protobuf.Timestamp
	30, // 5: sso.v1.JWKSResponse.keys:type_name -> sso.v1.JWK
	18, // 6: sso.v1.Auth.Register:input_type -> sso.v1.RegisterRequest
	20, // 7: sso.v1.Auth.Login:input_type -> sso.v1.LoginRequest
	22, // 8: sso.v1.Auth.CreateToken:input_type -> sso.v1.TokenRequest
	24, // 9: sso.v1.Auth.Logout:input_type -> sso.v1.LogoutRequest
	26, // 10: sso.v1.Auth.MassLogout:input_type -> sso.v1.MassLogoutRequest
	35, // 11: sso.v1.Auth.UpdateAccessToken:input_type -> sso.v1.AccessTokenRequest
	16, // 12: sso.v1.Auth.ChangePassword:input_type -> sso.v1.PasswordRequest
	14, // 13: sso.v1.Auth.ForgotPassword:input_type -> sso.v1.ForgotRequest
	12, // 14: sso.v1.Auth.ConfirmEmail:input_type -> sso.v1.EmailRequest
	6,  // 15: sso.v1.Auth.CheckConfirmToken:input_type -> sso.v1.CheckConfirmRequest
	8,  // 16: sso.v1.Auth.CheckForgotToken:input_type -> sso.v1.CheckForgotRequest
	10, // 17: sso.v1.Auth.ResetPassword:input_type -> sso.v1.ResetRequest
	3,  // 18: sso.v1.Auth.GetProfile:input_type -> sso.v1.ProfileRequest
	0,  // 19: sso.v1.Auth.GetServices:input_type -> sso.v1.ServicesRequest
	31, // 20: sso.v1.Auth.ValidateToken:input_type -> sso.v1.ValidateRequest
	33, // 21: sso.v1.Auth.RefreshToken:input_type -> sso.v1.RefreshRequest
	28, // 22: sso.v1.Auth.GetJWKS:input_type -> sso.v1.Empty
	19, // 23: sso.v1.Auth.Register:output_type -> sso.v1.RegisterResponse
	21, // 24: sso.v1.Auth.Login:output_type -> sso.v1.LoginResponse
	23, // 25: sso.v1.Auth.CreateToken:output_type -> sso.v1.TokenResponse
	25, // 26: sso.v1.Auth.Logout:output_type -> sso.v1.LogoutResponse
	27, // 27: sso.v1.Auth.MassLogout:output_type -> sso.v1.MassLogoutResponse
	36, // 28: sso.v1.Auth.UpdateAccessToken:output_type -> sso.v1.AccessTokenResponse
	17, // 29: sso.v1.Auth.ChangePassword:output_type -> sso.v1.PasswordResponse
	15, // 30: sso.v1.Auth.ForgotPassword:output_type -> sso.v1.ForgotResponse
	13, // 31: sso.v1.Auth.ConfirmEmail:output_type -> sso.v1.EmailResponse
	7,  // 32: sso.v1.Auth.CheckConfirmToken:output_type -> sso.v1.CheckConfirmResponse
	9,  // 33: sso.v1.Auth.CheckForgotToken:output_type -> sso.v1.CheckForgotResponse
	11, // 34: sso.v1.Auth.ResetPassword:output_type -> sso.v1.ResetResponse
	4,  // 35: sso.v1.Auth.GetProfile:output_type -> sso.v1.ProfileResponse
	1,  // 36: sso.v1.Auth.GetServices:output_type -> sso.v1.ServicesResponse
	32, // 37: sso.v1.Auth.ValidateToken:output_type -> sso.v1.ValidateResponse
	34, // 38: sso.v1.Auth.RefreshToken:output_type -> sso.v1.RefreshResponse
	29, // 39: sso.v1.Auth.GetJWKS:output_type -> sso.v1.JWKSResponse
